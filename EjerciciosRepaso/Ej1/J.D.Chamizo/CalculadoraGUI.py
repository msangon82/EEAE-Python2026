...
from Ejercicio_1 import Calculadora
...
class CalculadoraGUI:
    def __init__(self):
        ...
        tk.Button(self.root, text="Multiplicar",width=15, font=("Arial", 12), command=self.calcular_producto).pack(pady=5)
